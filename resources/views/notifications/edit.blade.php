...
@section('content')
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('notifications.update', $notification) }}">
                        ...
                        <div class="d-flex gap-2 mb-3">
                            ...
                            @if(!$notification->isSent() && ($organisation->hasFacebookPage() || $organisation->hasXAccount()))
                                <button type="button" 
                                        class="btn btn-sm btn-outline-secondary" 
                                        id="toggle-social"
                                        data-bs-toggle="collapse" 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Social field toggle (only if element exists)
            ...
            if (socialField && toggleSocial) {
                ...
                socialField.addEventListener('hidden.bs.collapse', () => {
                    ...
                    document.getElementById('post_to_facebook').checked = false;
                    document.getElementById('post_to_x').checked = false;
                });
            }
